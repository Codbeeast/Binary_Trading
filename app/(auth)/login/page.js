...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#111318] p-4 text-white relative overflow-hidden">
            ...
            {/* Orange Glow */}
            <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] bg-[#FF5722]/10 blur-[120px] rounded-full pointer-events-none" />
            <div className="absolute bottom-[-20%] right-[-10%] w-[50%] h-[50%] bg-[#FF5722]/5 blur-[120px] rounded-full pointer-events-none" />
            ...
            <div className="w-full max-w-md bg-[#1C1F26] border border-white/5 rounded-2xl p-8 shadow-2xl relative z-10 backdrop-blur-xl">
                ...
                <div className="space-y-4">
                    ...
                    <div className="relative flex items-center justify-center">
                        ...
                        <span className="bg-[#1C1F26] px-3 text-xs text-gray-500 uppercase relative z-10 font-medium">Or continue with email</span>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center justify-between">
                                ...
                                <Link href="#" className="text-xs text-[#FF5722] hover:text-[#FF8A65]">
                                    Forgot password?
                                </Link>
                            </div>
                            <div className="relative">
                ...
                <div className="mt-8 text-center">
                    <p className="text-gray-400 text-sm">
                        ...
                        <Link href="/register" className="text-white font-semibold hover:text-[#FF5722] transition-colors">
                            Create Account
                        </Link>
                    </p>
                </div>
